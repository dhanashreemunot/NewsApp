...
class _myAppState extends State<myApp> {
  ...
  void getData() async {
    var myresponse = await http.get(Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=us&apiKey=875fb44fe57147c989ea6925f856f290'));
              ...
              child: Row(
                children: [
                  Hero(
                      tag: 'logo1',
                      child: Image.network(
                        'https://www.nationsonline.org/gallery/USA/US-Capitol-Washington.jpg',
                        width: 50,
                        height: 50,
                      )),
                  SizedBox(
